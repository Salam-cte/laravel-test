			...
			<section class="panel home" id="A">
				<div class="inner">
					<div class="home-banner banner">
						<div class="container">
							<h1 class="h1-banner " data-aos="fade-up" data-aos-delay="100" >{{ $content[1]->title }}</h1>
							<p class="p-banner section1-p " data-aos="fade-up" data-aos-delay="200">{!!html_entity_decode($content[1]->sub_title) !!}</p>
							<div class="banner-btns mt-5 " data-aos="fade-up" data-aos-delay="300">
							...
							<img src="{{url('storage/app/public')}}/{{$content[1]->image}}" class="banner-img"  data-aos="fade-up" data-aos-delay="400">
						</div>
					</div>
				</div>
			</section>
				...
				<div class="inner">
					...
					<div class="section1">
						...
						<div class="section1-content">
							<h1 class="h1-banner"  data-aos="fade-up" >{{ $content[2]->title }}</h1>
							<a href="#" >
					...
					<div class="container">
						<div class="row">
							<div class="col-md-6 col-sm-12">
								...
								<div class="banner-btns mt-5" >
									<a class="banner-play" target="_blank"  data-aos="fade-left" href="https://play.google.com/">
										<img src="{{ asset('images/google-play-btn.svg') }}" class="footer-img">
										{{-- <span> GET IT ON</span>
												<h4 class="h4-2">Google Play</h4> --}}
									</a>
									<a class="banner-play" target="_blank" data-aos="fade-right" href="https://www.apple.com/">
